...
function App() {
  const [inputText, setInputText] = useState('print("Made with 💓 by CodewithTHARUN")');
  ...
  const handleSubmit = async (e) => {
    ...
    const options = {
      ...
      headers: {
        ...
        'X-RapidAPI-Key': 'b10816bf15mshdd160c82440cf56p1b9797jsn925725bde731',
  ...
  return (
    <>
      <div className='flex flex-row justify-between p-5 text-3xl'>
        ...
        <a href="https://github.com/THARUN2939" className='ml-auto gap-1 text-xl bg-black text-white px-2 py-1 rounded flex justify-end items-center' target='_blank' rel='noreferrer'>
